...
function PopUp({popUpState,userName,myImage,handlePopUp}){
    ...
    return(
        <section>
            <div id="defaultModal" tabIndex="-1" onClick={handleGrayClick} aria-hidden="true" className={ `${popUpState} bg-gray-200 bg-opacity-50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center inset-0 h-modal h-full`}>
                            ...
                            <div className="grid">
                                ...
                                <div className="grid sm:w-2/3 sm:mx-auto gap-2 pl-2">
                                    ...
                                    <div className="flex justify-center items-center w-full">
                                        <label htmlFor="dropzone-file" className="flex flex-col justify-center items-center w-auto h-32 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                            <div className="px-5 flex flex-col justify-center items-center pt-5 pb-6">
                                                <svg aria-hidden="true" className="mb-3 w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
