...
import { Navbar , Button  , DarkThemeToggle ,Dropdown , Avatar} from 'flowbite-react'
...
<Link to="/" className="flex items-center">
      <img src={cardlogo}  style={{width:"50px", height:"50px"}}alt="Flowbite Logo" />
  ...
  <span onClick={useLinkClickHandler("/")}>
    ...
    <span onClick={useLinkClickHandler("/services")}>
