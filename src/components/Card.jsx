...
const Card = ({ id, coverImage, title, description }) => {
  return (
    <Link to={`/set/${id}`}>
      <article
        className="group h-96 w-72 mx-auto transform cursor-pointer rounded-lg bg-cover overflow-hidden bg-no-repeat bg-center shadow-xl duration-500 hover:-translate-y-2"
